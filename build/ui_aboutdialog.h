...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About TWTCoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>TWTCoin</b> version", Q_NULLPTR));
...
"Copyright \302\251 2018 The TWTCoin developers", Q_NULLPTR));
